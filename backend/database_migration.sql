...
-- 执行以下命令验证表是否创建成功：
--
-- mysql -u root -p -e "USE food; SHOW TABLES LIKE 'recipe_records';"
-- mysql -u root -p -e "USE food; DESCRIBE recipe_records;"
-- mysql -u root -p -e "USE food; SELECT COUNT(*) FROM recipe_records;"
