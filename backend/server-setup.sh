...
read -rsp "Database password for eatwhat: " EATWHAT_DB_PASSWORD
echo
sudo mysql -e "CREATE USER IF NOT EXISTS 'eatwhat'@'localhost' IDENTIFIED BY '${EATWHAT_DB_PASSWORD}';"
...
echo "   mysql -u eatwhat -p food < /root/init_database.sql"
echo ""
echo "2. 上传后端jar包:"
