...
public interface UserMapper {
    ...
    @Select("SELECT id, open_id as openId, session_key as sessionKey, union_id as unionId, " +
            "nickname, avatar, register_time as registerTime, last_login_time as lastLoginTime, status " +
    ...
    @Insert("INSERT INTO users (open_id, session_key, union_id, nickname, avatar, register_time, status) " +
            "VALUES (#{openId}, #{sessionKey}, #{unionId}, #{nickname}, #{avatar}, NOW(), #{status})")
